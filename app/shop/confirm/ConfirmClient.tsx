...
export function ConfirmClient({ initialStatus, initialAmount }: { initialStatus: string; initialAmount: number }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#07120f] to-[#03110d] px-4 py-12">
      <div className="mx-auto max-w-lg rounded-2xl border border-white/8 bg-[#08140f]/95 p-6 text-center shadow-xl">
        {status === "success" ? (
          <>
